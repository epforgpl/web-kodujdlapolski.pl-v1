...
<head>
    ...
    <link rel="stylesheet" href="<?php bloginfo('template_url'); ?>/js/lib/jquery.fancybox/jquery.fancybox.css"
          media="screen">
    ...
    <nav class="navbar">
        <div class="navbar-header">
            <a href="/" class="navbar-brand"><img
                    src="<?php bloginfo('template_url'); ?>/images/logo-kodujdlapolski.png" width="167" height="77"
                    alt=""></a>
        </div>
