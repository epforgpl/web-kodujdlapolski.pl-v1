...
<header class="header">
    <div class="header-title">
        <p>Koduj Dla Polski to interdyscyplinarna społeczność poszukująca technologicznych rozwiązań społecznych
            problemów<br><a href="<?php the_field('join'); ?>"><strong>Dołącz do nas</strong></a></p>
    </div>
    <!-- / .header-title -->
    ...
    <div class="header-latest" <?php if (!$eventManager->haveEvents()) echo 'style="display: none;"'; ?>>
        <div class="header-latest-in">
            <div class="header-latest-bottom">
                ...
                <h1 class="header-latest-title">
                    ...
                    <span
                        class="header-latest-title-date"><?php echo date_i18n("j F", strtotime($upcomingEvent->eventStart)); ?></span>
        ...
        <a href="https://www.facebook.com/KodujDlaPolski/events" class="btn btn--reversed header-latest-btn">Zobacz
            kalendarz spotkań</a>
    </div>
    <!-- / .header-latest -->
    ...
    <tr>
            ...
            <a href="http://forum.kodujdlapolski.pl" target="_blank" style="color: #333333;">
                <div class="clearfix">
                    <figure class="stats-image">
                        <img src="<?php bloginfo('template_url'); ?>/images/icon-stats-registered.png" width=""
                             height="" alt="">
                    </figure>
                    <div class="stats-info">
                        <strong class="stats-info-number"><?php the_field('count_user'); ?></strong>
                        <span class="stats-info-label">osób zarejestrowanych na forum</span>
                    </div>
                </div>
            </a>
        </td>
        <td>
            <a href="http://forum.kodujdlapolski.pl/category/pomysly" target="_blank" style="color: #333333;">
                <div class="clearfix">
                    <figure class="stats-image">
                        <img src="<?php bloginfo('template_url'); ?>/images/icon-stats-ideas.png" width="" height=""
                             alt="">
                    </figure>
                    <div class="stats-info">
                        <strong class="stats-info-number"><?php
                            ...
                            ?></strong>
                        <span class="stats-info-label">zgłoszonych pomysłów na projekt</span>
                    </div>
                </div>
            </a>
        </td>
        <td>
            <a href="/brygady" style="color: #333333;">
                <div class="clearfix">
                    <figure class="stats-image">
                        <img src="<?php bloginfo('template_url'); ?>/images/icon-stats-teams.png" width="" height=""
                             alt="">
                    </figure>
                    <div class="stats-info">
                        <strong class="stats-info-number"><?php $count_posts = wp_count_posts('brigades');
                            echo $count_posts->publish; ?></strong>
                        <span class="stats-info-label">brygad</span>
                    </div>
                </div>
            </a>
        </td>
        <td>
            <a href="/projekty" style="color: #333333;">
                <div class="clearfix">
                    <figure class="stats-image">
                        <img src="<?php bloginfo('template_url'); ?>/images/icon-stats-projects.png" width="" height=""
                             alt="">
                    </figure>
                    <div class="stats-info">
                        <strong class="stats-info-number"><?php $count_posts = wp_count_posts('projects');
                            echo $count_posts->publish; ?></strong>
                        <span class="stats-info-label">wspieranych projektów</span>
                    </div>
                </div>
            </a>
        </td>
            ...
            <article class="threeBoxes-col">
                <div class="threeBoxes-in">
                    <figure class="threeBoxes-image">
                        ...
                        <img src="<?php echo $img['url']; ?>" width="<?php echo $img['width']; ?>"
                             height="<?php echo $img['height']; ?>" alt="<?php echo $img['alt']; ?>">
                    </figure>
                    <div class="threeBoxes-description">
                        <h1 class="threeBoxes-title"><a
                                href="<?php the_sub_field('url'); ?>"><?php the_sub_field('title'); ?></a></h1>
                        <?php the_sub_field('desc'); ?>
                        <a <?php if (get_sub_field('blank')) echo 'target="_blank"'; ?>
                            href="<?php the_sub_field('url'); ?>"
                            class="btn btn--primary"><?php the_sub_field('btn'); ?></a>
                    </div>
                </div>
            </article>
        <?php endwhile; ?>
