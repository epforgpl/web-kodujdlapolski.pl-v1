            ...
            <section class="members">
                ...
                <?php while (have_rows('team')): the_row(); ?>
                    ...
                    <div class="member-col">
                        <figure class="member-col-photo">
                            ...
                            ?>
                            <img src="<?php echo $img_post; ?>" width="<?php echo $width; ?>"
                ...
                if (!empty($email)): ?>
                    <div class="member-col member-col--add">
                        <figure class="member-col-photo">
                            <img src="<?php bloginfo('template_url'); ?>/images/image-add-brigade.jpg" width=""
                                 height="" alt="">
                        </figure>
                        <h2 class="member-col-title"><a class="open_ajax"
                                                        href="<?php bloginfo('template_url'); ?>/framework/project-email.php?id=<?php echo $post->ID; ?>&pozycja=Brygada%20<?php the_title(); ?>">Dołącz
                                <br>do brygady</a></h2>
                    </div>
                <?php endif; ?>
                </div>
                    ...
                    <?php foreach ($posts as $post): ?>
                        ...
                        <div class="projects-brigade-col">
                            <figure class="projects-brigade-col-image">
                                ...
                                $height = $img['sizes'][$size . '-height'];
                                ?>
                                <img src="<?php echo $img_mini; ?>" width="<?php echo $width; ?>"
                                     height="<?php echo $height; ?>">
                            </figure>
                    ...
                    <?php if (!$eventManager->BrygadaHasEvents(get_the_title())): ?>
                        ...
                        if (!empty($email)): ?>
                            <a style="margin-top: 0"
                               href="<?php bloginfo('template_url'); ?>/framework/events-email.php?id=<?php echo $post->ID; ?>&pozycja=Zaproponuj%20temat"
                               class="btn btn--reversed open_ajax">Zaproponuj temat</a>
                        <?php endif; ?>
                    ...
                    <?php else: ?>
                        ...
                        <h1 class="event-latest-title">
                            Najbliższe spotkanie <span
                                class="event-latest-title-date"><?php echo date_i18n("j F", strtotime($upcomingEvent->eventStart)); ?></span>
                        </h1>
                        <a href="http://facebook.com/events/<?php echo $upcomingEvent->eventId; ?>"
                           class="btn btn--reversed">Więcej</a>
                    <?php endif; ?>
                </div>
            </div>
        </aside>
